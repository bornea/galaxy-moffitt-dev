...
# installed.
TCL_PREFIX='/galaxy/builds/Linux-x86_64/install_dir'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/galaxy/builds/Linux-x86_64/install_dir'
...
TCL_EXTRA_CFLAGS='-I/galaxy/builds/Linux-x86_64/install_dir/include -pipe -I/galaxy/builds/Linux-x86_64/install_dir/include'
...
TCL_LD_FLAGS='-L/galaxy/builds/Linux-x86_64/install_dir/lib -Wl,-rpath,\$$ORIGIN/../lib -Wl,--export-dynamic'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/galaxy/builds/Linux-x86_64/tcl8.4.20/unix -ltcl8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/galaxy/builds/Linux-x86_64/install_dir/lib -ltcl8.4${TCL_DBGX}'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/galaxy/builds/Linux-x86_64/install_dir/include'
...
# compiled.
TCL_SRC_DIR='/galaxy/builds/Linux-x86_64/tcl8.4.20'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/galaxy/builds/Linux-x86_64/install_dir/lib '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/galaxy/builds/Linux-x86_64/tcl8.4.20/unix -ltclstub8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/galaxy/builds/Linux-x86_64/install_dir/lib -ltclstub8.4${TCL_DBGX}'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/galaxy/builds/Linux-x86_64/tcl8.4.20/unix/libtclstub8.4${TCL_DBGX}.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/galaxy/builds/Linux-x86_64/install_dir/lib/libtclstub8.4${TCL_DBGX}.a'
